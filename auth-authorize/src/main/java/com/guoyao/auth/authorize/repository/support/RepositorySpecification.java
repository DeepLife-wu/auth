 ...
 * 
 * @author wuchao
 * @Date 【2019年1月22日:上午10:37:46】
 * @param <T>
 * @param <C>
 */
public abstract class RepositorySpecification<T, C> extends AbstractEventConditionBuilder<T,C>
	implements Specification<T>{
	
	/**
	 * @param condition
	 */
	public RepositorySpecification(C condition) {
		super(condition);
	}
